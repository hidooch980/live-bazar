...
### Added
- **۲۷ ارز تازه در بازار آزاد ایران و نرخ جهانی**: روپیه پاکستان و هند،
  ریال قطر، عمان و عربستان، دینار کویت، بحرین و اردن، لیر سوریه، رینگیت
  مالزی، بات تایلند، دلار سنگاپور، هنگ‌کنگ و نیوزیلند، وون کره، کرون
  سوئد، نروژ و دانمارک، زلوتی، لئو، منات، درام، لاری، پوند مصر، تاکای
  بنگلادش، روپیه سریلانکا و نپال — همه از همان فید منتشرشده TGJU با
  تایم‌استامپ خودش، و همان کدها از زنجیره نرخ جهانی.
- آبشده مینی‌سایز و حباب سکه بهار و سکه گرمی.
- **تاریخ و روز ایران** در هدر خانه: «دوشنبه ۱۶ شهریور ۱۴۰۵» با ساعت
  تهران، از یک مبدل شمسی محلی (`JalaliDate`) بدون هیچ وابستگی جدید.

### Changed
- چرخه بررسی بازار از ۵ ثانیه به **۲ ثانیه**؛ فید ایران از ۱۵ به ۵ ثانیه
  و باکت کش CDN از ۱۰ به ۵ ثانیه.
- **نمایش تایمر از هدر برداشته شد.** کادنس یک جزئیات پیاده‌سازی است؛ جای
  آن تاریخ و روز بازار نشسته که خواننده واقعاً لازم دارد.
- **جمع‌آوری بازار ایران مقاوم‌تر شد**: پنج میرور به‌جای سه، و میروری که
  آخرین بار جواب داده اول امتحان می‌شود — یک میرور خاموش دیگر هر چرخه یک
  تایم‌اوت کامل هزینه نمی‌کند و فید «یخ‌زده» به نظر نمی‌رسد.

### Fixed
- **ماشین‌حساب بازنویسی شد.** انتخابگر قبلی یک `SegmentedButton` شش‌تایی
  بود، پس بیش از هشتاد ردیف دیگر اصلاً قابل انتخاب نبودند. حالا هر دو طرف
  از یک شیت جست‌وجوی فارسی انتخاب می‌شوند، دکمه جابه‌جایی دارد، ورودی
  ارقام فارسی/عربی و جداکننده هزارگان و ممیز «٫» را می‌پذیرد، خطا را با
  زبان آدمیزاد می‌گوید (به‌جای «داده معتبر موجود نیست» برای هر چیزی)، و
  زیر نتیجه منبع و سن هر دو قیمت و نرخ دلارِ استفاده‌شده را می‌نویسد.
- انتخابی که از اسنپ‌شات حذف شود دیگر دراپ‌داون را با مقدار ناموجود
  نمی‌ترکاند؛ به اولین گزینه موجود برمی‌گردد.
